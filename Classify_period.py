...
def process_file(file_path,mass=60):
    ...
    if check_start_left_right ==0 :
        while number_frame<= len(left_force)-100 : #each while  loop will be a cycle of both right and left leg
            ...
            period_left.append(left_end[-1] - left_start[-1])
        right_circle.pop()
        right_start.pop()
        stance_right.pop()
    ...
    # right
        ...
        while number_frame<= len(left_force)-100 : #each while  loop will be a cycle of both right and left leg
            ...
            right_end.append(number_frame-1)    
            period_right.append(right_end[-1] - right_start[-1])
...
# process_file(file_path="D:\\Python-AI\\VinMec_Trainee\\Running_Code_9.10 - Copy\\Tran Bao Nhi running\\MR32024-10-07-15-44_Treadmill_running_6.8kph.csv",mass=60)
# process_file(file_path="C:\\Users\\gochu\\Downloads\\Data Khuong running\\2024-10-31-10-36_Treadmill_5.0_kph.csv",mass=60)
